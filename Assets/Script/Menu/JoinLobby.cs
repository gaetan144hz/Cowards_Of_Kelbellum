...
public class JoinLobby : MonoBehaviour
{
    ...
    {
        datam_manager.data.NewPLayer(playerInput.playerIndex, playerInput.currentControlScheme, playerInput.devices[0]);
        // playerInput.playerIndex, , playerInput.devices[0].deviceId, playerInput.devices[0]
    }
